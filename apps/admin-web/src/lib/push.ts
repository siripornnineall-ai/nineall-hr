...
// key address push messages to a subscription; it carries no secret. Same keypair as
// employee-pwa (one Supabase project, one push_subscriptions table for both apps).
