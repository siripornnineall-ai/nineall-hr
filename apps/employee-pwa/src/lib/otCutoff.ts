...
// instead (see admin-web's calculatePayrollRunAction, which this mirrors). `monthKey` names
// a cutoff window by the month its 25th falls in, e.g. "2026-08" -> 2026-07-26 through
// 2026-08-25.
